...
void getGps()
{
  ...
  if (newData) {
    ...
    latitude = String(random(11.03835800, 11.03835829) + random(0, 999999) / 1000000.0, 6);
    longitude = String(random(76.26290,76.26291) + random(0, 999999) / 1000000.0, 6);
  }
  ...
  Serial.println("http://maps.google.com/maps?q="+latitude+","+longitude);
}
 ...
 void sendSms(String text)
{
  ...
  delay(1000);
  Serial.println("Unable To Find Gsm");
}
